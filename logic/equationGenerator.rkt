...
(define equation-generator%
  (class object%
    ...
    (define (trapezoid-area deviceContext)
      ...
      (cond
        [(inexact? answer) (set! answer2 (inexact->exact answer))]
        [(exact? answer) (set! answer2 (exact->inexact answer))])
    ...
    (define (middle-school-level-arithmetic-problem device-context)
      ...
      ;Parenthetical Generators
      (define par1 (random-natural 5))
      (define par2 (random-natural 5))
      (define par3 (random-natural 5))
      (define par4 (random-natural 5))

      (define asq (random-natural 5))
      (define bsq (random-natural 5))
      (define csq (random-natural 5))
      (define dsq (random-natural 5))
      (define asq2 (random-natural 5))
      (define bsq2 (random-natural 5))
      (define csq2 (random-natural 5))
      (define dsq2 (random-natural 5))
            ...
            [(0) (case (+ op2)
                   [(0) (case (+ op3)
                          [(0) (set! answer ($ a + b + c + d))
                               (set! answer2 (exact->inexact answer))]
      ...
      ;(get-output-string o)
      (print answer)
      (draw-text-problem-with-multiple-lines device-context (list "Solve the following equation (use floor for division): " (get-output-string o)))
    ...
    (define (high-level-arithmetic-problem device-context)
      ...
      (define csq (random-natural 5))
      (define dsq (random-natural 5))
      (define esq (random-natural 5))
      (define fsq (random-natural 5))
      (define gsq (random-natural 5))
      (define bsq2 (random-natural 5))
      (define csq2 (random-natural 5))
      (define dsq2 (random-natural 5))
      (define esq2 (random-natural 5))
      (define fsq2 (random-natural 5))
      (define gsq2 (random-natural 5))
